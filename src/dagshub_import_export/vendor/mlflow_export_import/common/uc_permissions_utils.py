...
from dagshub_import_export.vendor.mlflow_export_import.client.http_client import HttpClient
...
class UcPermissionsClient:
    def __init__(self, mlflow_client):
        ...
        self.client = HttpClient("api/2.1", host=creds.host, username=creds.username, password=creds.password)
