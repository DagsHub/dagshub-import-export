...
def set_experiment(mlflow_client, dbx_client, exp_name, tags=None):
    ...
    try:
        ...
        if not (ex.error_code == "RESOURCE_ALREADY_EXISTS" or exp_name == "Default"):  # DagsHub creates a default experiment automatically, but we don't throw correct errors on trying to create it.
