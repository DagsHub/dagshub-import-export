...
from dagshub_import_export.vendor.mlflow_export_import.model.export_model import export_model
from dagshub_import_export.vendor.mlflow_export_import.bulk import export_experiments
from dagshub_import_export.vendor.mlflow_export_import.bulk.model_utils import get_experiments_runs_of_models
...
def _export_models(
    ...
    for future in futures:
        ...
        if result[0]:
            ok_models.append(result[1])
        else:
            failed_models.append(result[1])
    duration = round(time.time() - start_time, 1)
