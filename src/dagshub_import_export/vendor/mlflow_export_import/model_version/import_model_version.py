...
from .click_options import opt_create_model, opt_experiment_name, opt_import_metadata, opt_import_stages_and_aliases
...
def _import_model_version(
    mlflow_client, model_name, src_vr, dst_run_id, dst_source, import_stages_and_aliases=True, import_source_tags=False
):
    ...
    with MlflowTrackingUriTweak(mlflow_client):
        dst_vr = mlflow_client.create_model_version(
            name=model_name, source=dst_source, run_id=dst_run_id, description=src_vr.get("description"), tags=tags
        )
